...
[Browser Caching Best Practices, When to use no-cache vs max-age without breaking your site](https://www.youtube.com/watch?v=z4XdfFscxSk)

[HTTP Strict Transport Security (HSTS) and TLS Stripping Explained](https://www.youtube.com/watch?v=kYhMnw4aJTw&list=PLQnljOFTspQU6zO0drAYHFtkkyfNJw1IO&index=23)

[HTTP/2 Critical Limitation that led to HTTP/3 & QUIC (Explained by Example)](https://www.youtube.com/watch?v=GriONb4EfPY&list=PLQnljOFTspQU6zO0drAYHFtkkyfNJw1IO&index=35)

[why it is very hard to cancel an HTTP request](https://www.youtube.com/watch?v=WmPKzFYKijM&list=PLQnljOFTspQU6zO0drAYHFtkkyfNJw1IO&index=52)

[Can you Cancel a REST HTTP Request](https://www.youtube.com/watch?v=HAadSWQpB3s&list=PLQnljOFTspQU6zO0drAYHFtkkyfNJw1IO&index=39)

[What is the Largest POST Request the Server can Process](https://www.youtube.com/watch?v=skwb7IH9TtY&list=PLQnljOFTspQU6zO0drAYHFtkkyfNJw1IO&index=44)
